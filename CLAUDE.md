...
- Tailwind CSS v4
- Prisma (MySQL) — 予約・スタッフ・管理者
- microCMS — ブログ・メニュー・ギャラリー
- NextAuth — 管理画面認証
...
## DB設計 (Prisma)
- Reservation: 予約 (顧客名, メール, 電話, メニュー, スタッフ, 日時, ステータス)
- Staff: スタッフ (名前, カレンダー色, 有効フラグ)
- Admin: 管理者 (メール, パスワード, 名前, ロール: OWNER/STAFF)

## microCMS コンテンツ
- toppage: トップページ
- blogs: ブログ記事 (タイトル, 本文, アイキャッチ, カテゴリ)
- menus: メニュー (名前, 説明, 価格, 施術時間, 画像, カテゴリ)
